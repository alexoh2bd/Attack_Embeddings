...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="mmeb_train_attacked")
    ...
    print(f"Loading MMEB-train dataset: {args.dataset}")
    ds = load_dataset("TIGER-Lab/MMEB-train", args.dataset, split="original")
    ...
    for idx in tqdm(range(num_to_process)):
        item = ds[idx]
        # Handle different column names for train vs eval
